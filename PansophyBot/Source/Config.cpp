...
namespace Config
{
    namespace ConfigFile
    {
		...
		std::string ConfigFileLocation = "bwapi-data/AI/Pansophy_Config.txt";
    }
    ...
    namespace BotInfo
    {
        std::string BotName                 = "PansophyBot";
        std::string Authors                 = "Dave Churchill, Kenny Young, Victor Olivares, Lingbo Tang, Ben Hunter";
